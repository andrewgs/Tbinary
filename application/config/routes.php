...
$route['admin-panel/actions/pages/lang/:num/page/trade']		= "admin_interface/trade_page";
$route['admin-panel/actions/pages/lang/:num/page/home']			= "admin_interface/menu_page";
...
$route['admin-panel/actions/pages/lang/:num/page/bussiness-partners']= "admin_interface/menu_page";
...
$route['bussiness-partners']= "users_interface/pages";
$route['start-trade']		= "users_interface/startTrade";
