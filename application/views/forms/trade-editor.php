	...
	<fieldset>
		...
		<?php for($p=0;$p<count($page);$p++):?>
			...
			<div class="tab-pane fade in active" id="part_<?=$p?>">
				<input type="hidden" name="trade_main" value="<?=$page[$p]['id'];?>">
			...
			<div class="tab-pane fade" id="part_<?=$p?>">
				<input type="hidden" name="trade_<?=$p?>" value="<?=$page[$p]['id'];?>">
			<?php if($page[$p]['title'] != 'trade_3'):?>
				<div class="control-group">
